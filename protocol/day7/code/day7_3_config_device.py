...
from protocol.day7.code.day7_1_create_db import Router, engine

# 导入正课中的netmiko代码
from protocol.day7.code.tools.ssh_client_netmiko import netmiko_config_cred
...
tem_path = Path(__file__).resolve().parent / 'templates'

# jinja2读取Cisco接口配置模板
interface_config_template = Template((tem_path / 'cisco_ios_interface.template').read_text(encoding='utf-8'))
# jinja2读取Cisco OSPF配置模板
ospf_config_template = Template((tem_path / 'cisco_ios_ospf.template').read_text(encoding='utf-8'))
