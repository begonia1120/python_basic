...
def bokeh_line(lines_data, title='速率趨勢', y_label='速率 (kbps)', save_name=None):
    """
...
if __name__ == '__main__':
    ...
    bokeh_line(
        [[times, [round(uniform(100, 2000), 2) for _ in range(10)], 'RX:10.10.1.1:Gi1'],
         [times, [round(uniform(100, 2000), 2) for _ in range(10)], 'TX:10.10.1.1:Gi1']],
         title='接口速率測試'
    )